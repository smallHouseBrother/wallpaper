...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5f];
    ...
    UIView * blackClear = [[UIView alloc] initWithFrame:CGRectMake(100, cancelBtn.top, self.view.frame.size.width-200, 50)];
    blackClear.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5f];
    [self.view addSubview:blackClear];
    ...
    confirmBtn.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5f];
...
- (void) panView:(UIPanGestureRecognizer *)panGestureRecognizer
{
    ...
    if (panGestureRecognizer.state == UIGestureRecognizerStateBegan || panGestureRecognizer.state == UIGestureRecognizerStateChanged) {
        ...
        view.frame = CGRectMake(view.left+translation.x, view.top+translation.y, view.width, view.height);
